...
const submit = () => form.post(route('pericias.store'));
</script>

<template>
    <Head title="Nova Perícia" />
    ...
    <AppLayout>
        <div class="max-w-2xl mx-auto">
            <div class="mb-8">
                ...
                <p class="font-lora italic text-parchment-800 opacity-75 mt-1">Adicione uma nova habilidade aos tomos.</p>
            </div>
