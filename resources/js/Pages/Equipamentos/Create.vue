...
const submit = () => form.post(route('equipamentos.store'));
</script>
...
<template>
    ...
    <AppLayout>
        <div class="max-w-2xl mx-auto">
            <div class="mb-8">
                <h1 class="text-3xl font-cinzel font-bold text-parchment-900 uppercase tracking-widest">Novo Item</h1>
                <p class="font-lora italic text-parchment-800 opacity-75 mt-1">Adicione um item ao inventário.</p>
            </div>
            ...
            <form @submit.prevent="submit" class="glass-parchment rounded-xl p-8 space-y-6 border border-parchment-400 shadow-xl">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input v-model="form.preco" type="text" placeholder="Ex: 5 po" class="w-full bg-parchment-100 border border-parchment-400 rounded-lg px-4 py-2 font-lora focus:outline-none focus:border-blood-700" />
                    </div>
                    <div>
