    ...
    public function run(): void
    {
        ...
        $magias = [
            ...
            [
                ...
                'resistencia_magia' => 'Sim', 'versao' => '3.5',
                'descricao' => 'A magia arcana mais poderosa do jogo, capaz de dobrar a realidade à vontade do conjurador. Você pode usar Desejo para: (1) duplicar qualquer magia arcana de até 8° círculo, sem componentes materiais nem foco daquela magia; (2) duplicar qualquer magia divina de até 7° círculo; (3) duplicar qualquer magia arcana ou divina de até 7° círculo mesmo fora da sua lista de classe; (4) restaurar completamente até 20 níveis de qualquer criatura tocada, curando ferimentos, doenças, envelhecimento, cegueira, surdez, atributos drenados, níveis negativos e maldições; (5) recolocar até 10 alvos consentidos em uma configuração dimensional segura, teletransportando-os a qualquer lugar; (6) resgatar aliados perdidos em outros planos; (7) desfazer efeitos catastróficos aos quais o conjurador foi vítima (transformações, morte, banimentos); ou (8) realizar prodígios menores dentro dos limites descritos no PHB (aparecer em um local, ganhar informações, etc.). Efeitos maiores que os anteriores — mudanças cósmicas, criação de artefatos, alteração da realidade — são possíveis mas ficam a critério absoluto do Mestre, geralmente com consequências devastadoras (interpretação vingativa da magia por forças cósmicas, custo exponencial de PX). Componente material valioso: XP. Cada uso de Desejo consome 5.000 pontos de experiência do conjurador — o preço garante que a magia raramente seja frívolo. Componentes: apenas V + XP.',
            ...
            [
                ...
                'duracao' => 'Instantânea', 'teste_resistencia' => 'Reflexos metade',
                'resistencia_magia' => 'Sim', 'versao' => '3.5',
                'descricao' => 'Você conjura quatro meteoros ígneos maciços do plano do fogo, cada um voando em direção a um alvo separado dentro do alcance longo. Você designa até quatro alvos ou pontos no chão (podem ser todos o mesmo ponto, se desejar concentrar poder). Cada meteoro requer ataque de toque à distância contra a criatura designada: se acertar, causa 2d6 de dano contuso (impacto direto — sem TR); ao mesmo tempo, o meteoro detona em uma explosão de 12 m de raio ao redor de onde caiu, causando 6d6 de dano de fogo (TR Reflexos metade) em todas as criaturas dentro da área. Se você errar o ataque direto, o meteoro ainda detona no local designado, e apenas o dano de área se aplica (a criatura originalmente alvo entra no TR normal como qualquer outra na área). Múltiplos meteoros podem sobrepor áreas de explosão — nesse caso, uma criatura no meio de duas ou mais áreas de dano de fogo faz um único TR mas sofre o dano de todas as explosões cumulativamente. A magia é o ápice do poder destrutivo evocador: potencialmente 8d6 contuso + 24d6 fogo (média 116 pontos) contra um único alvo, ou dano massivo distribuído por até 4 áreas simultaneamente. Componente material: nenhum requerido (apenas V, S).',
                'classes' => ['Mago' => 9, 'Feiticeiro' => 9],
            ],
            [
                ...
                'resistencia_magia' => 'Não', 'versao' => '3.5',
                'descricao' => 'Você para o fluxo do tempo para todo o resto do universo, ganhando 1d4+1 rodadas aparentes de ação totalmente livre. Enquanto o tempo está parado, você pode se mover, atacar, lançar magias, manipular objetos e realizar qualquer ação possível — mas nenhuma outra criatura ou objeto pode ser afetado diretamente por essas ações, pois estão congelados no tempo. Você não pode: atacar criaturas com magias hostis diretas (nem magias de dano em área que atinjam alvos congelados), pois estes efeitos exigem a passagem normal do tempo para acontecer; interagir com objetos que outras criaturas seguram (não pode roubar arma da mão do inimigo, mas pode pegar itens de superfícies); atacar diretamente criaturas. O que você pode fazer: mover-se para qualquer posição, lançar magias sobre si mesmo (Rapidez, Invisibilidade Superior, Deslocamento, Escudo, etc.), preparar Bola de Fogo em local estratégico (a explosão só acontece quando o tempo voltar), abrir portas, aplicar venenos ou beber poções, teleportar-se, etc. Um mago de alto nível pode usar Parar o Tempo para lançar 3-4 magias buff em si mesmo e teletransportar-se para posição vantajosa antes de qualquer inimigo agir. Quando o tempo retorna, todas as suas ações e magias preparadas resolvem-se simultaneamente na ordem que você preferir. Componente material: nenhum (V apenas).',
                'classes' => ['Mago' => 9, 'Feiticeiro' => 9],
            ],
            [
                ...
                'duracao' => 'Instantânea', 'teste_resistencia' => 'Nenhum',
                'resistencia_magia' => 'Sim', 'versao' => '3.5',
                'descricao' => 'Você profere uma única palavra mágica de poder tão avassaladora que mata instantaneamente um ser vivo com 100 PVs atuais ou menos. Não há TR — se o alvo estiver dentro do limite de PVs, o efeito acontece automaticamente. Criaturas com mais de 100 PVs são completamente imunes — a palavra passa por elas sem efeito. Como possui os descritores [Morte] e [Mental], criaturas imunes a mortes (mortos-vivos, constructos, elementais, imunes a energia negativa) ou a mentais (Vontade de Ferro, Mente em Branco) são imunes independente dos PVs. Não afeta plantas ou gosmas. Diferente de Dedo da Morte (7° círculo, permite TR), Palavra do Poder: Matar não permite TR — se o alvo está dentro do limite, morre. Contra magos, sacerdotes, ladinos, monges e outras classes de PVs médios, uma Palavra bem colocada pode terminar um combate em uma única ação. A imunidade acima de 100 PVs a torna inútil contra dragões grandes, colossos e outros oponentes de PVs elevados, mas contra oponentes de escala humana ainda mata infalivelmente. Não requer componente material — apenas V (uma única palavra falada). Ação padrão de conjuração, permite lançar em qualquer alvo dentro do alcance próximo.',
                'classes' => ['Mago' => 9, 'Feiticeiro' => 9],
            ],
            [
                ...
                'resistencia_magia' => 'Sim', 'versao' => '3.5',
                'descricao' => 'Você libera um grito sobrenatural aterrorizante — como o lamento de uma banshee morta — que emana em ondas mortíferas em torno de você. A magia afeta até uma criatura viva por nível de conjurador dentro de uma área de 12 m de raio ao redor de você (mas você não é afetado). Cada alvo escolhido deve fazer TR Fortitude ou morre instantaneamente. Como possui descritores [Morte] e [Sônico], criaturas imunes a morte (mortos-vivos, constructos, elementais, plantas), sônico (dragões negros, alguns constructos) ou surdas (imunidade a magias que requerem audição — inclui alvos com Silêncio ativo ou naturais surdos) são imunes automaticamente. A magia requer que o alvo possa ouvir você — dentro de uma área de Silêncio, o efeito falha. Você pode selecionar quais criaturas dentro da área serão alvo (até o limite por nível), poupando aliados no meio de um grupo de inimigos. Contra grupos numerosos e vulneráveis à magia (soldados, ladrões, ratos gigantes, kobolds), Lamento pode exterminar dezenas em uma única ação padrão. Componente material: nenhum requerido (apenas V — o próprio grito).',
                'classes' => ['Mago' => 9, 'Feiticeiro' => 9],
            ],
            [
                ...
                'resistencia_magia' => 'Não', 'versao' => '3.5',
                'descricao' => 'Você abre um portal circular flamejante entre o Plano Material e outro plano específico da sua escolha (mas apenas planos com os quais você tenha experiência ou conhecimento suficiente para ancorar). O portal tem 6 m de diâmetro e pode ser usado de duas formas: (1) Portal de Passagem — criaturas dispostas podem atravessar em qualquer direção durante a duração; (2) Convocação — você chama uma criatura específica de outro plano para se manifestar através do portal e atendê-lo por período negociável. Se for uma convocação de criatura específica (chamando um deus, um demônio poderoso, um paladino celestial), a criatura convocada tem direito a TR Vontade para resistir — se conseguir, o portal se abre mas ninguém aparece; se falhar, ela aparece e você deve barganhar seu serviço (frequentemente por preços altos: sacrifícios, favores, ouro, magias reciprocas). Não pode ser usada para convocar seres específicos que estejam do outro lado protegido por magias (barreiras planares antigas), nem para convocar deuses maiores (a menos que o próprio deus consinta). Componente material valioso: XP — cada uso consome 1.000 PX (mais se a convocação for de uma criatura particularmente poderosa). Componentes: V, S, XP. Duração da passagem: concentração + 1 rodada por nível. Uma das magias mais versáteis para campanhas planares — permite escape, ataque com apoio extraplanar ou pactos com seres cósmicos.',
            ...
            [
                ...
                'duracao' => 'Instantânea', 'teste_resistencia' => 'Nenhum; consulte o texto',
                'resistencia_magia' => 'Sim (inofensiva)', 'versao' => '3.5',
                'descricao' => 'A magia definitiva de restauração da vida — a versão mais completa e poderosa. Você retorna à vida qualquer criatura morta, mesmo sem restos corpóreos, mesmo se a morte ocorreu há séculos, mesmo se o corpo foi destruído por meios que impediriam Ressurreição normal (queimado por fogo divino, dissolvido por ácido antigo, desintegrado por magia arcana, consumido). A magia reconstrói o corpo do zero se necessário, chamando a alma de volta do plano onde estiver e restaurando-a a plena saúde. O alvo retorna com PVs máximos, todos os atributos, habilidades e memórias intactos. Não sofre perda de nível permanente (diferente de Ressuscitar). Doenças, venenos, cegueira, surdez, atributos drenados, níveis negativos, maldições — todos são simultaneamente curados. Se a criatura morreu por Aniquilar Alma (magia que destrói a alma), Ressurreição Total pode reconstituí-la parcialmente, mas o Mestre pode decidir efeitos ainda mais devastadores dependendo da campanha. Componente material extraordinariamente caro: pó de diamante no valor mínimo de 25.000 PO (consumido na conjuração) — a maior despesa contínua do arsenal divino. Componentes divinos completos (V, S, M, FD). Reserved para os maiores clérigos dos maiores templos, capazes de trazer de volta reis mortos há gerações, arcamentos derrotados, ou heróis lendários que desapareceram do mundo em eras passadas.',
                'classes' => ['Clérigo' => 9],
            ],
            [
                ...
                'resistencia_magia' => 'Sim', 'versao' => '3.5',
                'descricao' => 'Versão superior maior de Enervação (4° círculo). Você dispara um raio negro de energia negativa em ataque de toque à distância contra um ser vivo. Se acertar, o alvo recebe 2d4 níveis negativos imediatamente — o dano mais devastador do arsenal necromântico. Cada nível negativo impõe: -1 em todas as jogadas de ataque, testes de resistência, verificações de perícia e habilidade; -5 PVs máximos; -1 nível efetivo de conjurador (perde acesso ao maior espaço de magia); se for conjurador clerical, perde uma magia preparada do maior nível. Se o total de níveis negativos igualar ou exceder os DV atuais do alvo, ele morre instantaneamente. Diferente de Enervação, os níveis negativos são potencialmente PERMANENTES — 24 horas depois de aplicados, o alvo faz TR Fortitude para cada nível: falha o torna permanente até ser removido por Restauração Total ou magia equivalente; sucesso remove esse nível temporariamente. Contra mortos-vivos, o efeito é invertido: cura 2d4 × 5 PVs temporários que duram 1 hora — magia útil para reforçar mortos-vivos aliados poderosos como liches ou vampiros. Componente material: nenhum requerido (V, S apenas). Uma das magias que definitivamente fazem inimigo comum ser incapacitado para sempre — não é preciso matar quando dreno permanente já os arruína.',
                'classes' => ['Clérigo' => 9, 'Mago' => 9, 'Feiticeiro' => 9],
            ],
        ];
